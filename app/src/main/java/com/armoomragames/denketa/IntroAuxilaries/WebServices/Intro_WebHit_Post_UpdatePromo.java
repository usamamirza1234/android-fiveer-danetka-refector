...
public class Intro_WebHit_Post_UpdatePromo {
    ...
    public void postUpdatePromo(Context context, final IWebCallback iWebCallback,
                                String promoName, String discount, String redemption, String startDate, String endDate, String _id) {
        mContext = context;
        String myUrl = AppConfig.getInstance().getBaseUrlApi() + ApiMethod.Patch.updatePromo + _id;
        ...
        params.put("promoCode", promoName);
        params.put("discount",discount);
        params.put("redemption",redemption);
        params.put("startDate",startDate);
        params.put("endDate",endDate);



        Log.d("LOG_AS", "postUpdatePromo: " + myUrl + params);
        ...
        mClient.patch(myUrl, params, new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                        ...
                        try {
                            ...
                            Log.d("LOG_AS", "postUpdatePromo: strResponse" + strResponse);
